...
doc_events = {
	...
	"Payment Entry": {
		"on_submit": ["erpnext.regional.france.utils.create_transaction_log", "erpnext.accounts.doctype.payment_request.payment_request.make_status_as_paid", "erpnext.accounts.doctype.payment_request.payment_request.update_middleware"],
		"on_trash": "erpnext.regional.check_deletion_permission"
	},
	'Address': {
